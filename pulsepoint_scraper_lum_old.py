...
def check_agency():
    ...
    driver = webdriver.Chrome(service=s, options=chrome_options, seleniumwire_options=sw_options)
...
def scraper_main(li_instance):
    ...
    # driver = webdriver.Chrome(executable_path=CHROME_DRIVER_PATH, options=chrome_options,seleniumwire_options=sw_options,)
    driver = webdriver.Chrome(service=s, options=chrome_options, seleniumwire_options=sw_options)
